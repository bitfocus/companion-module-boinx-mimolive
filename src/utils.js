export default {
	getDocument: function (reference) {
	...
	getLayer: function (ref) {
		...
		//	this.debug('Layer is:', layer)
		if (layer) {
			const doc = this.getDocument('documents/' + layer[1])
			if (doc) {
